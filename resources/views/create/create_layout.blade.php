    ...
    <script type="text/javascript">
        $("document").ready(function () {
            ...
            $(add_button).click(function (e) { //on add input button click
                ...
                var $div = $(
                    '<div class="form-group catclass"><div class="card"><article class="card-body"><label>Category</label><select name="category[]" id=' +
                    category_id +
                    ' class="form-control select2-multiple"><option></option></select><label>Tests</label><select name="test[]" id=' +
                    test_id +
                    ' class="form-control select2-multiple" multiple="multiple"></select><div></div><a href="#" class="remove_field">Remove</a></article></div></div>'
                );
                    ...
                    error: function (error) {
                        if (error.responseJSON.errors) {
                            ...
                            firstItemDOM.insertAdjacentHTML('afterend',
                                '<div class="text-danger">' + firstErrorMessage +
                                '</div>');
